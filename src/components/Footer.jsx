...
function SocialIcon({ href, children, label }) {
  return (
    <a
      ...
      className="w-9 h-9 rounded-xl bg-white/10 border border-white/15 flex items-center justify-center text-white/80 hover:text-white hover:bg-blue-600 hover:border-blue-500 hover:scale-110 active:scale-95 transition-all duration-300 shadow-sm"
    >
      {children}
    </a>
  )
