      ...
      <div className="relative w-full min-h-[540px] sm:min-h-[580px] lg:min-h-[640px]">
        ...
        <div className={`relative z-10 ${PAGE_MAX} flex flex-col justify-center min-h-[460px] sm:min-h-[500px] lg:min-h-[560px] py-10 sm:py-14 lg:py-16`}>
          <div className="w-full max-w-[500px] lg:max-w-[46%] space-y-4 sm:space-y-5">
            <span className="inline-block bg-blue-600 text-white md:bg-white md:text-blue-600 font-bold tracking-[0.14em] text-[10px] sm:text-[11px] uppercase px-4 py-1.5 rounded-full border border-blue-200/50 shadow-sm">
              About Us
            </span>

            <h1 className="font-serif-display text-[1.75rem] sm:text-[2.25rem] lg:text-[2.5rem] xl:text-[2.65rem] font-bold text-white md:text-[#0a1f47] leading-[1.15] [text-shadow:_0_2px_8px_rgba(0,0,0,0.85)] md:[text-shadow:none]">
              Caring for Families, Building Healthier Lives
            </h1>

            <p className="text-white/95 md:text-[#0a1f47] text-[14px] sm:text-[15.5px] font-medium leading-relaxed max-w-lg [text-shadow:_0_1px_6px_rgba(0,0,0,0.85)] md:[text-shadow:none]">
