    ...
    <section className="relative w-full bg-[#f8fafe]">
      ...
      <div className="relative w-full min-h-[540px] sm:min-h-[580px] lg:min-h-[640px]">
        <div className="absolute inset-0 overflow-hidden">
          ...
          />
          {/* Mobile gradient (top-down) ensuring 100% text clarity across paragraph */}
          <div className="md:hidden absolute inset-0 bg-gradient-to-b from-[#f8fafe] via-[#f8fafe]/95 via-60% to-transparent pointer-events-none" />
        ...
        <div className={`relative z-10 ${PAGE_MAX} flex flex-col justify-center min-h-[460px] sm:min-h-[500px] lg:min-h-[560px] py-10 sm:py-14 lg:py-16`}>
          <div className="w-full max-w-[500px] lg:max-w-[46%] space-y-4 sm:space-y-5">
            ...
            <h1 className="font-serif-display text-[1.75rem] sm:text-[2.25rem] lg:text-[2.5rem] xl:text-[2.65rem] font-bold text-[#0a1f47] leading-[1.15]">
              Caring for Families, Building Healthier Lives
            </h1>

            <p className="text-[#0a1f47] text-[14px] sm:text-[15.5px] font-medium leading-relaxed max-w-lg">
